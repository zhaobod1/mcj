...
//分站申请列表
$modules['02_supplier']['07_sub_apply'] = 'substations.php?act=list'; // 未审核申请列表
$modules['02_supplier']['08_sub_list'] = 'substations.php?act=list&state=1'; // 审核完成列表
$_LANG['07_sub_apply'] = '分站申请列表';
$_LANG['08_sub_list'] = '分站列表';
// 微信权限
