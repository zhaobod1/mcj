...
$_LANG['sub_tel_placeholder'] = '区号-电话号码-分机号';
$_LANG['flow_js']['sub_consignee_not_null'] = '收货人姓名不能为空！';
$_LANG['flow_js']['sub_country_not_null'] = '请您选择收货人所在国家！';
$_LANG['flow_js']['sub_province_not_null'] = '请您选择收货人所在省份！';
$_LANG['flow_js']['sub_city_not_null'] = '请您选择收货人所在城市！';
$_LANG['flow_js']['sub_district_not_null'] = '请您选择收货人所在区域！';
$_LANG['flow_js']['sub_invalid_email'] = '您输入的邮件地址不是一个合法的邮件地址。';
$_LANG['flow_js']['sub_address_not_null'] = '收货人的详细地址不能为空！';
$_LANG['flow_js']['sub_tele_not_null'] = '固定电话不能为空！';
$_LANG['flow_js']['sub_shipping_not_null'] = '请您选择配送方式！';
$_LANG['flow_js']['sub_payment_not_null'] = '请您选择支付方式！';
$_LANG['flow_js']['sub_goodsattr_style'] = 1;
$_LANG['flow_js']['sub_tele_invaild'] = '固定电话号码不是有效的号码，\n请输入形如：区号-电话号码-分机号 的数字，\n如：0335-6025437或021-31756512';
$_LANG['flow_js']['sub_zip_not_num'] = '邮政编码只能填写数字';
$_LANG['flow_js']['sub_mobile_not_null'] = '手机号码不能为空!';
$_LANG['flow_js']['sub_mobile_invaild'] = '手机号码不是合法号码';
$_LANG['flow_js']['sub_mobile_or_tel_not_null'] = '手机号码和固定电话至少要填写一项';
