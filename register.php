...
//------------
//$mobile_phone='15264284269';
///* 手机注册时，用户名默认为u+手机号 */
//$username = generate_username_by_mobile($mobile_phone);
//
//$password='12345678';
//// 获得手机号归属地  by Jason  五月风软件工作室
//$nowapi_parm=array();
//$nowapi_parm['app']='phone.get';
//$nowapi_parm['phone']=$mobile_phone;
//$nowapi_parm['appkey']='25761';
//$nowapi_parm['sign']='dbae2690f53b395deb75840318dbc4ae';
//$nowapi_parm['format']='json';
//$result=nowapi_call($nowapi_parm);
//$arrIds=explode(',',$result['style_simcall']);
//$province_id=getRegionNameById($arrIds['1']);
//$city_id=getRegionNameById($arrIds['2']);
//$other['country']=1;
//$other['province']=$province_id;
//$other['province']=22;
//
//$other['city']=$city_id;
//$other['city']='284';
...
//根据 名称获取id
function getRegionNameById($regionName)
{
