...
function sendSMS ($mobile, $content, $time = '', $mid = '')
{
	...
	/* 青岛火一五信息科技有限公司huo15.com 日期：2017/1/22 */
	$http = 'http://api.smsbao.com/sms'; // 短信接口
	/* 青岛火一五信息科技有限公司huo15.com 日期：2017/1/22 end */
	...
	$sendurl = $smsapi."sms?u=".$uid."&p=".md5($pwd)."&m=".$mobile."&c=".urlencode($content);
